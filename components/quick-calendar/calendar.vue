...
.confirmView .solar, .confirmView .lunar {font-size: 34upx; color: #B28B65; line-height: 34upx; padding: 10upx 0upx;}
...
.confirmView .buttons .confirm {display: inline-block; padding: 20upx 40upx; margin-left: 40upx; border-radius: 10upx; background: #B28B65;}
</style>
